...
import 'package:social/UI/create_chatUser_added.dart';
import 'package:social/UI/diologue.dart';
...
class _ProfileState extends State<Profile> {
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => CreateChatUserAdded()));
                        },
                        child: CircleAvatar(
                        ...
                        children: [
                          Container(
                              ...
                              child: InkWell(
                                ...
                                child: Icon(MdiIcons.viewGallery)
                              )),
                          Container(
                              height: size.height * 0.06401229,
                              width: size.width * 0.45,
  ...
  showOptions(BuildContext context, size) {
    return showDialog(
        context: context,
        builder: (context) {
          return Center(
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => MainPost()));
                        },
                        child: buildRow(context, size, "Your Activity",
                      ...
                      InkWell(
                        ...
                        child: buildRow(context, size, "Nametag",
                            "assets/icons/NameTag.png"),
                      ),
                      buildRow(
                        context,
                        size,
                      ...
                      buildRow(context, size, "Settings",
